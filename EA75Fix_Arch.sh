...
# ==============================================================================
# Arch Linux Keyboard Function Key Fix
# ------------------------------------------------------------------------------
...
#
# Adapted for Arch Linux, which uses 'mkinitcpio' to manage the initramfs.
#
# USAGE:
...
fix_keyboard_fn_keys() {
    ...
    echo "--- Keyboard Function Key Fixer for Arch Linux ---"
    ...
    echo "Rebuilding the initramfs with 'mkinitcpio'. This may take a few moments..."
    if mkinitcpio -P; then
        echo "Initramfs rebuilt successfully."
    else
        echo "ERROR: Failed to rebuild initramfs with mkinitcpio."
        exit 1
    fi
